...
const footer =props=>{
    ...
    <div class="container">
      <div class="row row-grid align-items-center my-md">
        <div class="col-lg-6">
          <h3 class="text-white font-weight-light mb-2">Thank you for supporting us!</h3>
          <h4 class="mb-0 font-weight-light text-white">Let's get in touch on any of these platforms.</h4>
        </div>
      ...
      <div class="row align-items-center justify-content-md-between text-white ">
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2018
            <a href="#" target="_blank">FastFoods</a>.
          </div>
        </div>
        <div class="col-md-6">
          <ul class="nav nav-footer justify-content-end">
            <li class="nav-item">
              <a href="#" class="nav-link" target="_blank" className="text-white">FastFoods</a>
            </li>
